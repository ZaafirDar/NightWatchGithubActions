# NightWatchGithubActions
This Repository contains a framework for executing NightWatchJS Automated test for Mobile Native Apps on Github Actions 

# Mocha Test Automation Framework with Appium, TypeScript, and Nightwatch.js

This repository contains a test automation framework built using Mocha, Appium, TypeScript, and Nightwatch.js. It follows the Page Object Model (POM) design pattern for organizing test automation code.
...
- Java Development Kit (JDK) installed for Appium
- Android SDK or Xcode installed for mobile testing
